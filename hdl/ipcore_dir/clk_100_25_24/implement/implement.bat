...
xst -ifn xst.scr
move clk_100_25_24_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\clk_100_25_24_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc clk_100_25_24_exdes.ucf clk_100_25_24_exdes

echo 'Running map'
map -timing -pr b clk_100_25_24_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm clk_100_25_24_exdes -w routed.ncd routed.v
cd ..
